...
export const products: Product[] = [
  {
    slug: 'manual-vmm', name: 'Manual VMM', family: 'Video Measuring Machine', badge: 'Operator controlled',
  ...
  {
    slug: 'semi-automatic-vmm', name: 'Semi-Auto VMM', family: 'Video Measuring Machine', badge: 'Signal feedback',
  ...
  {
    slug: 'cnc-auto-vmm', name: 'CNC Auto VMM', family: 'Video Measuring Machine', badge: 'Programmable inspection',
  ...
  {
    slug: 'automatic-vmm-cabinet', name: 'Automatic VMM', family: 'Video Measuring Machine', badge: 'Cabinet integrated',
  ...
  {
    slug: 'vms-manual', name: 'VMS Manual', family: 'Vision Measuring System', badge: 'Compact industrial',
