...
export default function ProductsPage() {
  ...
  const filtered = useMemo(() => products.filter((product) => {
    const matchesCategory = category === 'All systems' || product.name.toLowerCase().includes(category.toLowerCase().replace(' integrated', ''))
